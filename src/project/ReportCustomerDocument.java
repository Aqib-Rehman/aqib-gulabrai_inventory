...
public class ReportCustomerDocument implements Printable{
  private boolean b=false;
  private TransactionRecord transactionRecords[];
  private CustomerTransactionRecord customerTransRec;
  private int pageNo;
  ...
  public ReportCustomerDocument(TransactionRecord transactionRecords[], CustomerTransactionRecord customerTransRec, int pageNo,boolean IS_LAST_PAGE,  int TOTAL_PAGE) {
     this.transactionRecords=transactionRecords;
     this.customerTransRec=customerTransRec;
     this.pageNo=pageNo;
  ...
  String HEADING2="Customer Transactions";
  ...
  String PREVOIUS_BALANCE_LABEL="PREVIOUS BALANCE: ";
  ...
  String DATE_FROM=customerTransRec.dateFrom;
  String DATE_TO=  customerTransRec.dateTo;
  String CUSTOMER_NAME=  customerTransRec.customer_name;

  String CREDIT_AMOUNT="Rs. "+customerTransRec.getCreditAmount();
  String DEBIT_AMOUNT="Rs. "+customerTransRec.getDebitAmount();
  String CURRENT_BALANCE=customerTransRec.getCurrentBalance();
  String PREVOIUS_BALANCE=customerTransRec.getPreviousBalance();
  ...
  double balance=customerTransRec.getBalance();
  boolean IS_CREDIT=customerTransRec.isCredit();

  String BALANCE="Rs. "+balance+"/ "+ (IS_CREDIT? "CREDIT":"DEBIT");
...
if(DATE_TO!=null){
 ...
 /******************************************************/
  ...
  if(IS_LAST_PAGE){
    ...
    if(PREVOIUS_BALANCE==null)PREVOIUS_BALANCE="Nil";
    ...
    y+=fontMetrics.getHeight();
    g2d.drawString (PREVOIUS_BALANCE_LABEL,0,y);
    g2d.drawString (PREVOIUS_BALANCE,fontMetrics.stringWidth(PREVOIUS_BALANCE_LABEL)+3,y);
